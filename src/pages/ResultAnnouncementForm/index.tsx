...
import Animation from '../../assets/animations/3596-win-result-2.json'
...
import styles from './ResultAnnouncementForm.module.scss'
...
export default function ResultAnnouncementForm() {
